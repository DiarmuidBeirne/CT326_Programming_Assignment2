package assignment2;// CommissionWorker class derived from Employee
...
public final class CommissionWorker extends Employee {
    ...
    public CommissionWorker(String first, String last,
                            double salary, double commission, int quantity, int year, int month, int day, int hour, int minute) {
